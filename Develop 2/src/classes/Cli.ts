...
class Cli {
  ...
  vehicles: (Car | Truck | Motorbike)[]; // Union operator to define additional types for the array
  ...
  static generateVin(): string {
    ...
    return (
      Math.random().toString(36).substring(2, 15) + // what this line does is it generates a random string of 15 characters
      Math.random().toString(36).substring(2, 15)  // what this line does is it generates a random string of 15 characters
    );
  }
  ...
  // TODO: add a parameter to accept a truck object by using the Union operator at the end of the parameter list
  findVehicleToTow(truck: Truck): void {
    inquirer
      ...
      .then((answers) => {
        console.log("this.findVehicleToTow",answers);
