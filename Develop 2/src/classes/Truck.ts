...
class Truck extends Vehicle implements AbleToTow {
  ...
  // TODO: Create a constructor that accepts the properties of the Truck class and initializes the properties so that the Truck class can be instantiated with or without the wheels array
